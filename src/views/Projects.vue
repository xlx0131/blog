  ...
  <div class="min-h-[100dvh] bg-[#f5f0e8] pt-24 pb-20">
    <div class="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-20">
        ...
        <div v-for="project in filteredProjects" :key="project.id" class="group cursor-pointer bg-[#fffaef] border-2 border-[#161310] shadow-[6px_6px_0_0_#161310] transition-all duration-200 hover:-translate-y-1 hover:translate-x-0.5 tilt-card" @click="viewProject(project)">
          <div class="relative h-44 border-b-2 border-[#161310] overflow-hidden bg-[#2e5dd6]">
            ...
            <div class="absolute top-[60px] left-1/2 -translate-x-1/2 z-10 flex items-center justify-center w-14 h-14 bg-[#f5f0e8] border-2 border-[#161310] shadow-[3px_3px_0_0_#161310]">
              ...
              <svg v-else-if="project.cover === 'todo'" class="w-7 h-7 text-[#161310]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><path d="M9 12l2 2 4-4"/><path d="M9 16l2 2 4-4"/></svg>
              <svg v-else-if="project.cover === 'skills'" class="w-7 h-7 text-[#161310]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="4" ry="4"/><circle cx="9" cy="10" r="2.5"/><circle cx="15" cy="10" r="2.5"/><path d="M8 16c0 1.5 1.5 3 4 3s4-1.5 4-3"/></svg>
              <svg v-else-if="project.cover === 'course'" class="w-7 h-7 text-[#161310]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>
      ...
      <div class="container-image">
        ...
        <svg v-else-if="project.cover === 'todo'" class="image-circle" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><path d="M9 12l2 2 4-4"/><path d="M9 16l2 2 4-4"/></svg>
        <svg v-else-if="project.cover === 'skills'" class="image-circle" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="4" ry="4"/><circle cx="9" cy="10" r="2.5"/><circle cx="15" cy="10" r="2.5"/><path d="M8 16c0 1.5 1.5 3 4 3s4-1.5 4-3"/></svg>
        <svg v-else-if="project.cover === 'course'" class="image-circle" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>
        ...
        <div class="product-image">
          <div class="box-image">
            <div class="box-image-content">
              ...
              <svg v-else-if="project.cover === 'todo'" class="img-product" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><path d="M9 12l2 2 4-4"/><path d="M9 16l2 2 4-4"/></svg>
              <svg v-else-if="project.cover === 'skills'" class="img-product" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="4" ry="4"/><circle cx="9" cy="10" r="2.5"/><circle cx="15" cy="10" r="2.5"/><path d="M8 16c0 1.5 1.5 3 4 3s4-1.5 4-3"/></svg>
              <svg v-else-if="project.cover === 'course'" class="img-product" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>
